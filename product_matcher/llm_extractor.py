...
Instead of hardcoded brand/model regex, this module sends product names to an
LLM and asks it to return structured fields (brand, model, variant, specs).
Works for any product category in any language.
